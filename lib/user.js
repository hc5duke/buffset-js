(function() {
  ...
  User = (function() {
    ...
    User.prototype.newBuffset = function(buffsetType) {
      return {
    ...
    User.prototype.update = function(options, admin, callback) {
      ...
      if (options.buffset_type != null) {
        buffset = this.newBuffset(options.buffset_type);
        updates.$push = {
          buffsets: buffset
        };
      }
  ...
  User.findAll = function(conditions, order, callback) {
    ...
    order || (order = {});
    return this.db.collection('users', function(error, users) {
      return users.find(conditions).sort(order).toArray(function(error, allUsers) {
        if (error) {
          return callback(false);
        } else {
